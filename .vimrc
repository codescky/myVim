...
"Plugin    'http://www.vim.org/scripts/script.php?script_id=3884'
Plugin     'vim-scripts/DfrankUtil'

"Plugin   'http://www.vim.org/scripts/script.php?script_id=3221'
Plugin     'shemerey/vim-indexer'


"Plugin    'http://www.vim.org/scripts/script.php?script_id=3872'
...
"Plugin       'http://www.vim.org/scripts/script.php?script_id=2624'
Plugin       'ProtoDef'

"Plugin  'http://www.vim.org/scripts/script.php?script_id=2590'
Plugin       'FSwitch'
...
Plugin     'https://github.com/gcmt/wildfire.vim'

Plugin      'Gundo'

Plugin      'https://github.com/Lokaltog/vim-easymotion'

"Plugin      'https://stackedit.io/editor'
